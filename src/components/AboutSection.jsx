...
const AboutSection = () => {
  ...
  return (
    <div id="about-section" className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black py-16 sm:py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className={`text-center mb-12 sm:mb-16 space-y-4 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mb-16 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
          ...
          <div className="space-y-4 sm:space-y-6">
            <h3 className="text-2xl sm:text-3xl md:text-3xl font-bold text-white">Globally Recognized Excellence</h3>
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {stats.map((stat, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <div className="text-2xl sm:text-4xl font-bold text-white mb-1 group-hover:scale-110 transition-transform duration-300">{stat.value}</div>
